const audio = document.getElementById('audioElement-1');
const bassControl = document.getElementById('low-eq-1');
const midControl = document.getElementById('med-eq-1');
const trebleControl = document.getElementById('hi-eq-1');
